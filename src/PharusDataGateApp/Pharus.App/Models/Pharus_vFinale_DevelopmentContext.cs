...
{
    public partial class Pharus_vFinale_DevelopmentContext : DbContext
    {
        public Pharus_vFinale_DevelopmentContext()
        {
        }

        public Pharus_vFinale_DevelopmentContext(DbContextOptions<Pharus_vFinale_DevelopmentContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=PHA-SQL-01;Database=Pharus_vFinale_Development;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.FileStreamId, e.StartConnection });

                entity.ToTable("tb_map_filefund");

                entity.Property(e => e.FileStreamId).HasColumnName("file_stream_id");
