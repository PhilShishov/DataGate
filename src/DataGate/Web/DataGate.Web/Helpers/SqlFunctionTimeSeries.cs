namespace DataGate.Web.Helpers
{
    public class SqlFunctionTimeSeries
    {
        ...
        // Sub Funds
        public const string TimeSeriesSF = "SELECT convert(varchar, date_ts, 103)date_ts , value_ts [type], " +
        ...
        //public const string PricesSubFund = "SELECT CONCAT(MONTH(date_ts),'/', YEAR(date_ts)), " +
        ...
        //public const string DatesSubFund = "SELECT CONCAT(MONTH(date_ts),'/', YEAR(date_ts)) " +
        ...
        //SELECT date_ts, CONCAT(MONTH(date_ts),'/', YEAR(date_ts))
        //        FROM [tb_timeseries_subfund]
        //        join tb_dom_timeseries_provider tsp on tsp.id_provider = provider_ts
        //        where id_subfund = 1
        //        GROUP BY MONTH(date_ts), YEAR(date_ts)
