	...
	function setup($) {
		...
		function install(el, opts) {
			...
			if (msie || opts.forceIframe)
				lyr1 = $('<iframe class="blockUI" style="display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="' + opts.iframeSrc + '"></iframe>');
			else
				lyr1 = $('<div class="blockUI" style="display:none"></div>');

			if (opts.theme)
				lyr2 = $('<div class="blockUI blockOverlay ui-widget-overlay" style="display:none"></div>');
			else
